...
Aside from this, all other code was entirely written myself and invoked only my own creativity and understanding, or was written due to theoretical information gained from one of the other two links I presented. I have outlined to the best of my ability the areas within my project that were inspired by MIT licensed code so as to stay consistent with the guidelines of the MIT license (license included in the repository, please read the above for specific details on which code the third-party section of the license applies to and which code my part of the license applies to, if you are using strictly only third-party code then only include the third-party section of the license, if you are using only my code then only include my section of the license, and if you are using both then include the entire license).
